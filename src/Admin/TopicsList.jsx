...
const TopicsList = ({ selectedCourse, onEditTopic, onEditLesson, onUpdateTopic, topic, lesson  }) => {
      ...
      <Modal show={showEditTopicModal} onHide={handleCloseEditTopicModal}>
        ...
        <Modal.Body>
          <form onSubmit={handleUpdateTopic}>
            ...
            <button type="submit" className="btn action-btn ">Update Topic</button>
          </form>
        </Modal.Body>
      </Modal>
      ...
      <Modal show={showEditLessonModal} onHide={handleCloseEditLessonModal}>
        ...
        <Modal.Body>
          <form onSubmit={handleUpdateLesson}>
            ...
            <button type="submit" className="btn action-btn ">Update Lesson</button>
          </form>
        </Modal.Body>
      </Modal>
