...
function Sidebar(props){
    ...
    return(
        <>
        <div className=" hidden border-e-2 border-slate border-solid md:block w-[20%] sticky top-0">
            ...
            <div className="px-3 py-2  flex flex-row gap-2  hover:bg-menuwhite" onClick={initsetter}>
            ...
            <FacilitatorStudentSelectButton text='CI/CD' onClick={props.onClick}/>
         </div>
        </>
    )
}
