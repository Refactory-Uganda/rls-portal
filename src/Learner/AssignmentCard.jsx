...
const AssignmentCard = ({ title, dueDate, status, handleCardClick }) => {
  ...
  return (
    <div className="assignment-card" onClick={handleCardClick}>
      <div className="assignment-header">
        <FontAwesomeIcon icon={faClipboardList} size="2x" />
        <h4 style={{ fontSize: "1rem", fontWeight: "bold" }}>{title}</h4>
      </div>
      <div className="assignment-details">
        <span>
          <strong>Due Date:</strong> {dueDateObj.toLocaleDateString()}
        </span>
